...
public final class VarUtf8EncodingEncoder
{
    ...
    public VarUtf8EncodingEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public VarUtf8EncodingEncoder length(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final VarUtf8EncodingDecoder decoder = new VarUtf8EncodingDecoder();
